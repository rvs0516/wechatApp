...
class Prpcrypt
{
    ...
    public function decrypt($encrypted, $receiveId)
    {
        ...
        try {
            ...
            //拆分，解密后有random、msg_len、msg、receiveid四个字段，其中msg即为消息内容明文
            $content = substr($result, 16, strlen($result));
            $len_list = unpack('N', substr($content, 0, 4));
            $xml_len = $len_list[1];
            $xml_content = substr($content, 4, $xml_len); // msg即为消息内容明文
            $from_receiveId = substr($content, $xml_len + 4); // 企业ID
            ...
            // var_dump( $from_receiveId );
            // exit;

            // string(41) "9101248766798716140wwe6ce267036e47037"
            // array(1) {
            // [1]=>
            // int(19)
            // }
            // int(19)
            // string(19) "9101248766798716140"
            // string(18) "wwe6ce267036e47037"
